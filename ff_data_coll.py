...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar  7 09:42:50 2021

@author: matthewfalcona
"""

# the following code for data acquisition courtesy of rmeyer1
...
#        driver = webdriver.Firefox(profile, executable_path=r"/Users/matthewfalcona/opt/anaconda3/bin/geckodriver", options=opts)
     ...
     #   switcher_ids = ['switcher_stats_squads_shooting', 'switcher_stats_squads_passing', 'switcher_stats_squads_gca', 'switcher_stats_squad_possession']
        ...
        for i in range(len(tables)):
            ...
            """
               ...
               # switcher = driver.find_elements_by_xpath('//*[@id="{}"]'.format(switcher_ids[i]))
...
def write_table_data_to_csv(data_frames):
    try:
        ...
        df.to_csv('{base_dir}/FalconaForecast/datasets/fbref_data_{current_date}.csv'.format(base_dir=BASE_DIR, current_date=datetime.now()), index = True)
    except:
